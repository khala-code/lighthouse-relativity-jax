...
class SimConfig:
    ...
    H0: float = 0.0
    void_peak: float = 18.0
    void_sigma: float = 0.45
    noise_std: float = 0.005
    D_spatial: float = 0.05
    D_z: float = 0.05          # NEW: Vertical scale diffusion coupling
    lambda_scale: float = 0.02 # NEW: Vertical chiral scale torque coupling
    kappa_grav: float = 0.3
    B0: float = 50.0e-6
    B1: float = 0.0
